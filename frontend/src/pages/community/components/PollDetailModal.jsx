              ...
              <div className="flex space-x-3">
                ...
                <div className="flex-1">
                  <textarea
                    ...
                    className="w-full min-h-[80px] px-4 py-3 border-2 border-slate-300 rounded-lg bg-white text-slate-900 font-medium shadow-sm placeholder:text-slate-400 hover:border-slate-400 focus:border-primary focus:outline-none focus:ring-4 focus:ring-primary/20 disabled:bg-slate-50 resize-vertical transition-all duration-200"
                  />
