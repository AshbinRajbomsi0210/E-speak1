                ...
                <div className="flex items-center space-x-3 mt-4">
                  ...
                  <div className="flex-1 flex items-center space-x-2">
                    <input
                      ...
                      className="flex-1 h-10 px-4 py-2 text-sm border-2 border-slate-300 rounded-lg bg-white text-slate-900 font-medium shadow-sm placeholder:text-slate-400 hover:border-slate-400 focus:border-primary focus:outline-none focus:ring-4 focus:ring-primary/20 transition-all duration-200"
                    />
                    <Button
                      size="sm"
